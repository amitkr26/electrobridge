...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/resume/tailor`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.8 },
    { url: `${base}/ai-resume-builder`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.9 },
    { url: `${base}/ats-resume-checker`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.9 },
